...
const SERIF = '"Microsoft YaHei", "PingFang SC", system-ui, sans-serif';
  ...
  return (
    <AbsoluteFill
      style={{
        ...
        alignItems: 'center',
        opacity: fadeOut,
        backgroundImage: 'radial-gradient(1100px 750px at 50% 42%, rgba(255,252,244,.9), transparent 65%)',
      }}
    >
      <div style={{ textAlign: 'center', maxWidth: 1500 }}>
        <div
          style={{
            ...
            color: '#104737', letterSpacing: '-0.012em',
            ...
            return (
              <span
                ...
                style={{
                  ...
                  fontStyle: 'normal',
                  color: w.accent ? '#c58b35' : undefined,
                }}
              >
                {w.text}
              </span>
        ...
        <div
          style={{
            ...
            background: '#c58b35', transform: `scaleX(${underline})`,
          }}
        />
        {sub ? (
          <div style={{ fontFamily: MONO, fontSize: 34, letterSpacing: '0.08em', color: 'oklch(50% 0.006 82)', marginTop: 34, opacity: subT, textTransform: 'uppercase', display: 'flex', justifyContent: 'center', alignItems: 'baseline', gap: '0.5em' }}>
            {subDigits ? <DigitRoll value={subDigits} delay={12} fontSize={34} /> : null}
            <span>{sub}</span>
          </div>
        ) : null}
      </div>
